...
import { signUpRequest } from "../../store/action-creators/auth-actions/sign-up";
...
export const SignUP = () => {
    ...
    // const isLoading = useSelector(store => store.signUpData.loading);
    ...
    const formik = useFormik({
        ...
        validate,
        onSubmit: values => {
            dispatch(signUpRequest(values.firstName, values.lastName, values.email, values.password));
        }
    });
