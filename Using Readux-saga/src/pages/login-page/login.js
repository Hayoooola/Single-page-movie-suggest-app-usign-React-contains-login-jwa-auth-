...
import loginRequest from '../../store/actions/auth-actions/loginRequest';
import loginStatusRequest from '../../store/actions/auth-actions/checkLoginStatus';
...
export const LoginPage = () => {
    ...
    // request to check login status
    useEffect(() => {
        dispatch(loginStatusRequest());
    }, []);
    ...
    useEffect(() => {
        if (loginData.authData.access_token) {
